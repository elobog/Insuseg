...
namespace Insuseg.Analytics.Data.Migrations
{
    ...
    [Migration("20260817030233_AddDeliveryNoteLineSalesPersonCode")]
    partial class AddDeliveryNoteLineSalesPersonCode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Insuseg.Analytics.Data.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Insuseg.Analytics.Data.Entities.Sale", b =>
                {
                    ...
                    b.HasKey("DocEntry", "SourceDocType");
            ...
            modelBuilder.Entity("Insuseg.Analytics.Data.Entities.SaleLine", b =>
                {
                    b.Property<int>("DocEntry")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("GrossBuyPrice")
                        .HasPrecision(18, 4)
                        .HasColumnType("decimal(18,4)");
                    ...
                    b.HasKey("DocEntry", "SourceDocType", "LineNum");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Insuseg.Analytics.Data.Entities.ApplicationUser", null)
                        .WithMany()
